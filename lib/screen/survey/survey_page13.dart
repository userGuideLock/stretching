...
import 'package:stretching/screen/survey/survey_page14.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController13 extends GetxController {
...
class SurveyPage13 extends StatelessWidget {
  const SurveyPage13({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController13>(
      init: SurveyViewController13(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step13': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage14(),
...
Widget _buildButton(SurveyViewController13 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController13>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
