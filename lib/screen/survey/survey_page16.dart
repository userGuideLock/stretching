...
import 'package:stretching/screen/survey/survey_page17.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController16 extends GetxController {
...
class SurveyPage16 extends StatelessWidget {
  const SurveyPage16({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController16>(
      init: SurveyViewController16(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step16': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage17(),
...
Widget _buildButton(SurveyViewController16 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController16>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
