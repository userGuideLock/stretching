...
import 'package:stretching/screen/survey/survey_page20.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController19 extends GetxController {
...
class SurveyPage19 extends StatelessWidget {
  const SurveyPage19({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController19>(
      init: SurveyViewController19(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step19': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage20(),
...
Widget _buildButton(SurveyViewController19 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController19>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
