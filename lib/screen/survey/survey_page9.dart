...
import 'package:stretching/screen/survey/survey_page10.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController9 extends GetxController {
...
class SurveyPage9 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController9>(
      init: SurveyViewController9(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step9': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage10(),
...
Widget _buildButton(SurveyViewController9 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController9>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
