...
import 'package:stretching/screen/survey/survey_page15.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController14 extends GetxController {
...
class SurveyPage14 extends StatelessWidget {
  const SurveyPage14({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController14>(
      init: SurveyViewController14(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step14': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage15(),
...
Widget _buildButton(SurveyViewController14 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController14>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
