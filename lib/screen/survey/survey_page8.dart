...
import 'package:stretching/screen/survey/survey_page9.dart';

class SurveyViewController8 extends GetxController {
...
class SurveyPage8 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController8>(
      init: SurveyViewController8(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step8': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage9(),
...
Widget _buildButton(SurveyViewController8 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController8>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
