...
import 'package:stretching/screen/survey/survey_page8.dart';

class SurveyViewController7 extends GetxController {
...
class SurveyPage7 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController7>(
      init: SurveyViewController7(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step7': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage8(),
...
Widget _buildButton(SurveyViewController7 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController7>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
