...
import 'package:stretching/screen/survey/survey_page11.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController10 extends GetxController {
...
class SurveyPage10 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController10>(
      init: SurveyViewController10(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step10': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage11(),
...
Widget _buildButton(SurveyViewController10 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController10>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
