...
import 'package:stretching/screen/survey/survey_page18.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController17 extends GetxController {
...
class SurveyPage17 extends StatelessWidget {
  const SurveyPage17({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController17>(
      init: SurveyViewController17(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '지난 한달 동안 당신은 잠이 들기 위해 얼마나 자주 약을 복용했습니까?\n(처방약 또는 약국에서 구입한 약)',
                      style: TextStyle(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step17': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage18(),
...
Widget _buildButton(SurveyViewController17 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController17>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
