...
import 'package:stretching/screen/survey/survey_page7.dart';

class SurveyViewController6 extends GetxController {
...
class SurveyPage6 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController6>(
      init: SurveyViewController6(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      '최근 1개월 동안, 당신이 꼭 해야하는 일을 처리할 수 없다고 생각한 적이 얼마나 있었습니까?',
                      style: TextStyle(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step6': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage7(),
...
Widget _buildButton(SurveyViewController6 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController6>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
