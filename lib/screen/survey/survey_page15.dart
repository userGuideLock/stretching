...
import 'package:stretching/screen/survey/survey_page16.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController15 extends GetxController {
...
class SurveyPage15 extends StatelessWidget {
  const SurveyPage15({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController15>(
      init: SurveyViewController15(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step15': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage16(),
...
Widget _buildButton(SurveyViewController15 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController15>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
