...
import 'package:stretching/screen/survey/survey_page13.dart';
import 'package:stretching/screen/survey/survey_page4.dart';

class SurveyViewController12 extends GetxController {
...
class SurveyPage12 extends StatelessWidget {
  const SurveyPage12({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SurveyViewController12>(
      init: SurveyViewController12(), // 컨트롤러 초기화
      builder: (controller) {
        return Scaffold(
                      ...
                      child: ElevatedButton(
                        onPressed: controller.selectedButton.isNotEmpty
                            ? () {
                                ...
                                final combinedData = {
                                  ...previousData,
                                  'step12': controller.selectedButton
                                };
                                Get.to(() => const SurveyPage13(),
...
Widget _buildButton(SurveyViewController12 controller, String buttonLabel) {
  return GetBuilder<SurveyViewController12>(
    builder: (_) {
      return SizedBox(
        width: double.infinity,
